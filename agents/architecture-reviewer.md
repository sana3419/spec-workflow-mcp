...
tags: ['architecture']
triggers:
  paths: ['**/core/**', '**/domain/**', '**/services/**']
  content: ['import .* from [''"](\.\./){2,}', '\bglobalThis\b|\bprocess\.on\(', '\bsingleton\b']
---
...
Write the report to `.spec-workflow/reports/agent-architecture-reviewer-<YYYYMMDD-HHMMSS>.md` and print it.
