...
tags: ['infra', 'iac']
triggers:
  paths: ['**/Dockerfile*', '**/docker-compose*', '**/*.tf', '**/*.tfvars', '**/k8s/**', '**/helm/**', '**/kustomize/**', '**/manifests/**']
---
...
Write the report to `.spec-workflow/reports/agent-iac-reviewer-<YYYYMMDD-HHMMSS>.md` and print it.
