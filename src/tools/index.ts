...
import { reviewRouteTool, reviewRouteHandler } from './review-route.js';
  ...
  try {
    switch (name) {
      ...
      case 'log-implementation':
        ...
        break;
      case 'verify-task':
        response = await verifyTaskHandler(args, context);
        break;
      case 'review-route':
        response = await reviewRouteHandler(args, context);
        break;
      default:
